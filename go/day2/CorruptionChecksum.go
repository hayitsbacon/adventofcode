...
const spreadsheet = `116	1470	2610	179	2161	2690	831	1824	2361	1050	2201	118	145	2275	2625	2333
...
func main() {
  ...
  // Part 2
	...
	for _, row := range rows {
		...
		row_div_sum += num / denom
	}

	fmt.Println("Checksum:",checksum)
	fmt.Println("Row Division Sum:",row_div_sum)
